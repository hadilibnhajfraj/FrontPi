...
@Component({
  selector: 'app-fetch-activite',
  templateUrl: './fetch-activite.component.html',
  styleUrls: ['./fetch-activite.component.css']
})
export class FetchActiviteComponent implements OnInit {
  activite: Activite[] = [];
  selectedGallery: any[] = [];
  temperature: string;
  weatherCondition: string;
  id_user: string = ''; // Variable pour stocker l'id de l'utilisateur
